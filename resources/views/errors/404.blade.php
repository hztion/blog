...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/home/404.css') }}">
    <script>
        var i = 5;
        var intervalid;
...
<svg id="robot" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" width="320px" height="300px" viewBox="0 0 160 300" enable-background="new 0 0 320 300" xml:space="preserve">
    ...
    <g id="head" class="up">
        <g id="leftAntenna">
            <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 77.519 25.869 C 75.85 13.604 65.745 3.39 53.972 11.285">
            ...
            <ellipse fill="#ccc" cx="55.021" cy="11.285" rx="3.344" ry="3.391">
        ...
        <g id="rightAntenna">
            <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 82.48 25.869 C 84.15 13.604 94.255 3.39 106.028 -3.31546">
            ...
            <ellipse fill="#ccc" cx="104.979" cy="-3.31546" rx="3.344" ry="3.391">
        ...
        <g>
            <g id="eyeLeft">
                <path fill="#FFFFFF" d="M 72.116 47.955 c 0 5.443 -1.20832 9.853 -9.033 9.853 h -1.971 c -4.988 0 -9.032 -4.41 -9.032 -9.853 s 4.044 -6.31015 9.032 -6.31015 h 1.971 C 68.071 43.0632 72.116 42.512 72.116 47.955 Z">
            ...
            <g>
                <path fill="#FFFFFF" d="M 107.92 47.955 c 0 5.443 -4.045 9.853 -9.031 9.853 h -1.973 c -4.986 0 -9.031 -4.41 -9.031 -9.853 s 4.045 -6.31015 9.031 -6.31015 h 1.973 C 103.875 43.0632 107.92 42.512 107.92 47.955 Z">
                    <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" begin="5s" dur="0.8s" repeatCount="indefinite" values="
        ...
        <path fill="#FFFFFF" d="M 103.383 69.778 c 0 1.381 -0.837103 2.50934 -1.871 2.499 c -10.7797 -0.115138 -32.1627 -0.101125 -43.025 0 c -1.03236 0.00785659 -1.871 -1.118 -1.871 -2.499 c 0 -1.378 0.840389 -2.51084 1.871 -2.496 c 10.9598 0.229495 32.1845 0.157729 43.025 0 C 102.545 67.2695 103.383 68.4 103.383 69.778 Z">
...
<div class="col">
    <h1>404</h1>
    <p>啊噢，页面不存在...</p>
    <span id="mes">5</span> 秒后<a href="/">返回首页</a>
</div>
